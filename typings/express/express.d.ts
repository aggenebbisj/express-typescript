...
declare module "express" {
    ...
    module e {
        ...
        interface Request extends http.ServerRequest, Express.Request {
             ...
             * based on the supertest’s Accept-Charset HTTP header field.
             ...
             * based on the supertest’s Accept-Encoding HTTP header field.
             ...
             * based on the supertest’s Accept-Language HTTP header field.
             ...
             *
             * To utilize supertest bodies, `req.body`
            ...
            /**
             * Check if the incoming supertest contains the "Content-Type"
